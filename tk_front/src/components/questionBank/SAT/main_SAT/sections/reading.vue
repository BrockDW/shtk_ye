          ...
          <el-col :span="24">
            ...
            >
              <el-row :gutter="30" style="padding: 20px 20px;">
                <el-col :span="6">
                  <div class="grid-content" v-for="i in section_1.slice(0, 13)" :key="i">
                ...
                <el-col :span="6">
                  <div class="grid-content" v-for="i in section_1.slice(13, 26)" :key="i">
                    <el-row style="margin-top: 5px">
                      <el-col :span="4" :offset="8">
                        <div
                          :class="{'choice':1, 'isWrong':wrongList[i-1], 'isCorrect':correctList[i-1]}"
                ...
                <el-col :span="6">
                  <div class="grid-content" v-for="i in section_1.slice(26, 39)" :key="i">
                    <el-row style="margin-top: 5px">
                      <el-col :span="4" :offset="8">
                        <div
                          :class="{'choice':1, 'isWrong':wrongList[i-1], 'isCorrect':correctList[i-1]}"
                ...
                <el-col :span="6">
                  <div class="grid-content" v-for="i in section_1.slice(39, 53)" :key="i">
                    <el-row style="margin-top: 5px">
                      <el-col :span="4" :offset="8">
                        <div
                          :class="{'choice':1, 'isWrong':wrongList[i-1], 'isCorrect':correctList[i-1]}"
...
export default {
  ...
  mounted() {
    this.section_1 = this.$store.state.section_1;
    this.section_1_answer = this.$store.state.section_1_answer;
    this.radioType = true;
    this.user_answer = this.$store.state.section_1_user_answer;
  ...
  methods: {
    ...
    handleSubmit() {
      if (this.user_answer.length != 52) {
        this.visible = false;
      } else {
        this.visible = true;
        this.$store.state.statusReading = "success";
        this.$store.state.showReading = true;
        this.disabled = true;
        this.beforeSubmit = 1;
        for (var i = 0; i < 52; i++) {
          if (this.user_answer[i] == this.section_1_answer[i]) {
            this.wrongList.push(0);
            this.correctList.push(1);
            this.$store.state.countReading++;
          } else {
            this.wrongList.push(1);
            this.correctList.push(0);
            this.$store.state.wrongReading.push(this.section_1[i]);
          }
        }
    ...
    nextSection() {
      ...
      this.$store.state.section_1_user_answer = this.user_answer;
