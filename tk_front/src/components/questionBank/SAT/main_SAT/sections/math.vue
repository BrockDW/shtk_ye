        ...
        <el-row>
          <el-col :span="24">
            <div
              ...
              style="border: 1px solid; height: 398px; width: 550px;"
            >
              <el-row :gutter="30" style="padding: 20px 20px;">
                <el-col :span="6">
                  <div class="grid-content" v-for="i in section_4.slice(0, 8)" :key="i">
                ...
                <el-col :span="6">
                  <div class="grid-content" v-for="i in section_4.slice(8, 16)" :key="i">
                    <el-row style="margin-top: 5px">
                      <el-col :span="4" :offset="8">
                        <div
                          :class="{'choice':1, 'isWrong':wrongList[i-1], 'isCorrect':correctList[i-1]}"
                ...
                <el-col :span="6">
                  <div class="grid-content" v-for="i in section_4.slice(16, 24)" :key="i">
                    <el-row style="margin-top: 5px">
                      <el-col :span="4" :offset="8">
                        <div
                          :class="{'choice':1, 'isWrong':wrongList[i-1], 'isCorrect':correctList[i-1]}"
                ...
                <el-col :span="6">
                  <div class="grid-content" v-for="i in section_4.slice(24, 30)" :key="i">
                    <el-row style="margin-top: 5px">
                      <el-col :span="4" :offset="8">
                        <div
                          :class="{'choice':1, 'isWrong':wrongList[i-1], 'isCorrect':correctList[i-1]}"
          ...
          <el-col :span="24">
            ...
            >
              <el-row :gutter="30" style="padding-left:16px; padding-top:12px">
                <el-col :span="6" v-for="i in section_4.slice(30, 34)" :key="i">
              ...
              <el-row :gutter="30" style="padding-left:16px; padding-top:12px">
                <el-col :span="6" v-for="i in section_4.slice(34, 38)" :key="i">
                  <div class="grid-content">
                    <el-row>
                      <el-col :span="6" style="padding-top:26px">
                        <div
...
export default {
  ...
  mounted() {
    this.section_4 = this.$store.state.section_4;
    this.section_4_answer = this.$store.state.section_4_answer;
    this.radioType = true;
  ...
  methods: {
    ...
    handleSubmit() {
      if (this.user_answer.length != 38) {
        this.visible = false;
      } else {
        this.visible = true;
        this.$store.state.statusMath = "success";
        this.$store.state.showMath = true;
        this.disabled = true;
        this.beforeSubmit = 1;
        for (var i = 0; i < 38; i++) {
          if (this.user_answer[i] == this.section_4_answer[i]) {
            this.wrongList.push(0);
            this.correctList.push(1);
            this.$store.state.countMath++;
          } else {
            this.wrongList.push(1);
            this.correctList.push(0);
            this.$store.state.wrongMath.push(this.section_4[i]);
          }
        }
    ...
    nextSection() {
      ...
      this.$store.state.section_4_user_answer = this.user_answer;
